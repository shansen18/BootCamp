...
# at the time listed.
awk '/05:00:00 AM/ {print $1,$2,$5,$6}' *schedule > Dealers_working_during_losses
awk '/08:00:00 AM/ {print $1,$2,$5,$6}' *schedule >> Dealers_working_during_losses
awk '/02:00:00 PM/ {print $1,$2,$5,$6}' *schedule >> Dealers_working_during_losses

# below searches the files starting with the four digit date followed by
# the * used as a wild card. 
awk '/08:00:00 PM/ {print $1,$2,$5,$6}' 0310* 0312* >> Dealers_working_during_losses
awk '/11:00:00 PM/ {print $1,$2,$5,$6}' 0310* 0312* >> Dealers_working_during_losses
